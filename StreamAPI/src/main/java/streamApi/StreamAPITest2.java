...
public class StreamAPITest2 {
    ...
    public void test3() {
        ...
        Double sumMoney = salaryStream.reduce((double) 0, Double::sum);
        Optional<Double> sumMoney2 = employees.stream().map(Employee::getSalary).reduce( Double::sum);
        System.out.println(sumMoney.toString());
        System.out.println(sumMoney2.get());
    }
